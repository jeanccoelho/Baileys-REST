...
export class ContactStorageService {
  ...
  private mapContactFromPrisma(contact: PrismaContactType): Contact {
    return {
      ...
      whatsapp_exists: contact.whatsappExists ?? undefined,
      whatsapp_jid: contact.whatsappJid || undefined,
      whatsapp_status: contact.whatsappStatus || undefined,
      whatsapp_picture: contact.whatsappPicture || undefined,
      whatsapp_business: contact.whatsappBusiness,
      whatsapp_verified_name: contact.whatsappVerifiedName || undefined,
      whatsapp_business_hours: contact.whatsappBusinessHours || undefined,
      whatsapp_website: contact.whatsappWebsite || undefined,
      whatsapp_email: contact.whatsappEmail || undefined,
      whatsapp_address: contact.whatsappAddress || undefined,
      whatsapp_category: contact.whatsappCategory || undefined,
      metadata: contact.metadata,
      last_whatsapp_check: contact.lastWhatsappCheck || undefined,
